...
Hybrids carry a stable earned name with a primary and secondary path. Visual expression shifts dynamically to reflect current dominant path within the blend. Hybrid status is not permanent — sustained neglect of one path dissolves it over time. Earning and dissolution follow ceremonial narrative sequences of equal weight and tone. All ten identities (four base classes, six hybrids) are peers — equal in mythic weight, equal in cool factor.
DATE: April 21, 2026
