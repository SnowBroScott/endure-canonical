...
Each class channels a distinct internal source of power. These sources express themselves visually, thematically, and experientially — not through spellcasting, but through embodiment.
...
## Hybridization (Conceptual Overview)
...
This separation keeps core class identity clean while allowing future expansion.
...
Endure is not a fitness app with fantasy flavor.
